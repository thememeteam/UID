...
import { ContactShadows, Environment, MeshReflectorMaterial, PresentationControls, Stage } from "@react-three/drei";
	...
	return (
		<div className="w-full h-full grid grid-rows-[auto_1fr] grid-cols-[2fr_1fr]">
			...
			<div className="row-start-2 col-start-1">
				<Canvas shadows camera={{ position: [0, 0.2, 4.5], fov: 30 }}>
